...
//деректор отправляет через каждую минуту сообщение и называет, сколько прошло таких минут до часа,
//наблюдатель считывает время прям с тайм сервера и сделать отдельно часы.
